...
void loop() {
  ...
  }else if(serial_flag4_2){
    stepper_z.setCurrentPosition(0);
    stepper_x.moveTo(-2000);
    stepper_x.setSpeed(-100);
    serial_flag4_2 = false;

  }else if(serial_flag5_2){
    stepper_z.setCurrentPosition(0);
    stepper_y.moveTo(-2000);
    stepper_y.setSpeed(-100);
    serial_flag5_2 = false;

  }else if(serial_flag6){
    stepper_z.setCurrentPosition(0);
    //stepper_z.moveTo(-20000);
    stepper_z.moveTo(-200);
...
//    Serial.println("7");
  ...
  }else if(serial_z_down){
    stepper_z.moveTo(1);
    stepper_z.setSpeed(130);
    z_control_flag = true;
    serial_z_down = false;
  ...
  if(stepper_z.currentPosition() == 36000){
    stepper_z.moveTo(40000);
    stepper_z.setSpeed(20);
    
  }else if(stepper_x.currentPosition() == 2000){
    stepper_x.setCurrentPosition(0);
    stepper_x.moveTo(0);
  ...
  }else if(stepper_y.currentPosition() == 2000){
    stepper_y.setCurrentPosition(0);
    stepper_y.moveTo(0);
  ...
  }else if( (z_control_flag && (stepper_z.currentPosition() == 1) ) || (z_control_flag && (stepper_z.currentPosition() == -1) ) ){
    z_control_flag = false;
    stepper_z.setCurrentPosition(0);
    stepper_z.moveTo(0);
    stepper_z.setSpeed(0);

  }else if(finish_flag && (stepper_z.currentPosition() == -200)){
    finish_flag = false;
    stepper_z.setCurrentPosition(0);
    stepper_z.moveTo(0);
    stepper_z.setSpeed(0);
