...
//      if(stepper_z.currentPosition() == -10){
//        Serial.print("dok");
//      }
    } else if (line2.equals("Z+")) {
//      stepper_z.setSpeed(1);
...
//    Serial.println(axis.currentPosition());
    axis.runSpeedToPosition();
    Z_suport();
//    stepper_z.runSpeed();
    stepper_z.runSpeedToPosition();
    if(stepper_z.currentPosition() == 10 || stepper_z.currentPosition() == -10){
      Serial.print("sok");
      stepper_z.setCurrentPosition(0);
    }
    stop_check();
...
//    int pulse1 = 2000;
    ...
    stepper_x.setSpeed(pulse1);
    while (stepper_x.currentPosition() != distance1) {
...
//    int pulse1 = 2000;
    ...
    stepper_z.setSpeed(0);
    stepper_y.moveTo(distance1);
    stepper_y.setSpeed(pulse1);
    while (stepper_y.currentPosition() != distance1) {
