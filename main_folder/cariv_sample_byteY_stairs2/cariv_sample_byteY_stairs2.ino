...
void loop() {
  ...
  if(serial_flag3){
    ...
    move_to(stepper_y, 250, 100);
    Serial.println("a");
//    stepper_x.stop();
    serial_flag_a = false;
  }else if (serial_flag_b){
    move_to(stepper_y, 500, 100);
    Serial.println("b");
//    stepper_x.stop();
    serial_flag_b = false;
  }else if (serial_flag_c){
    move_to(stepper_y, 750, 100);
    Serial.println("c");
//    stepper_x.stop();
    serial_flag_c = false;
  }else if (serial_flag_d){
    move_to(stepper_y, 1000, 100);
    Serial.println("d");
//    stepper_x.stop();
    serial_flag_d = false;
  }else if (serial_flag_e){
    move_to(stepper_y, 1250, 100);
    Serial.println("e");
//    stepper_x.stop();
    serial_flag_e = false;
  }else if (serial_flag_f){
    move_to(stepper_y, 1500, 100);
    Serial.println("f");
//    stepper_x.stop();
    serial_flag_f = false;
  }else if (serial_flag_g){
    move_to(stepper_y, 1750, 100);
    Serial.println("g");
//    stepper_x.stop();
    serial_flag_g = false;
  }else if (serial_flag_h){
    move_to(stepper_y, 2000, 100);
    Serial.println("h");
//    stepper_x.stop();
    serial_flag_h = false;
